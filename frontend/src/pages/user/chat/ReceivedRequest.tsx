        ...
        return (
          ...
          >
            ...
            <div className="flex gap-2 flex-wrap items-center">
              ...
              {req.status === "rejected" && (
                <span className="text-xs font-medium px-2.5 py-1 rounded-full text-red-400 bg-red-50 border border-red-200">
                  Rejected
                </span>
              )}
              ...
              {req.status === "blocked" && (
                <>
                  <span className="text-xs font-medium px-2.5 py-1 rounded-full text-gray-500 bg-gray-100 border border-gray-200">
                    Blocked
                  </span>
                  <button
